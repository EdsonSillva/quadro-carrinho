...
void ResetAcao(String ChaveAcaoNew, byte R, byte G, byte B, byte Brilho){
  //Serial.print("0-Dentro da rotina ResetAcao() - ChaveAcaoOld = "), Serial.println(ChaveAcaoOld);
...
void LedsShowBoxFixoAcao(String ChaveAcaoNew, byte R, byte G, byte B, byte Brilho, pTipoFuncaoVoid pFuncaoBox ){
  if(ChaveAcaoNew != ChaveAcaoOld){
...
//Serial.print("0-Dentro da rotina ResetAcao() dentro do If - ChaveAcaoOld = "), Serial.println(ChaveAcaoOld);
//    Serial.println("Saiu da while da rotinaFim LedsXadrez");
//    Serial.println("Saiu da while da rotinaFim LedsXadrez");
//    Serial.print("ChaveAcaoNew = "), Serial.println(ChaveAcaoNew);
//    Serial.print("ChaveAcaoOld = "), Serial.println(ChaveAcaoOld);
//  Serial.print("0-Dentro da rotina LedsBatmanAcesos() - ChaveAcaoOld = "), Serial.println(ChaveAcaoOld);
//  Serial.print("0-Dentro da rotina LedsBatmanAcesos() - ChaveAcaoNew = "), Serial.println(ChaveAcaoNew);
